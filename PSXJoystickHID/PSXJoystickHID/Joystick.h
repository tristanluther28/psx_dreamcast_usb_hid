...
#define _JOYSTICK_H_
	...
	/* Type Defines: */
		...
		typedef struct
		{
			...
			int8_t  Rx; /**< Current absolute joystick Rx position, as a signed 8-bit integer */
			int8_t  Ry; /**< Current absolute joystick Ry position, as a signed 8-bit integer */
			int8_t  Rz; /**< Current absolute joystick Rz position, as a signed 8-bit integer */
			int8_t  Slider; /**< Current absolute joystick Rz position, as a signed 8-bit integer */
